...
public class SubscriberController {
    ...
    public String loggedIn(@Valid @ModelAttribute("subscriber") Subscribers subscriber, Model model, BindingResult result) {
        ...
        Subscribers existingUserUsername = subscriberService.findByEmail(subscriber.getUsername());
        ...
        Subscribers existingUserEmail = subscriberService.findByEmail(subscriber.getEmail());
        ...
        return "sign_up"; // Assuming you have an "index.html" template
    }
